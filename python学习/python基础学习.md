...
<img src="C:\Users\felixsfan\Desktop\办公机备份\学习\python学习\images\编译型和解释型执行流程.png" style="zoom:50%;" />
...
Python 几乎支持所有常见的平台，比如 Linux、Windows、Mac OS、[Android](http://m.biancheng.net/android/)、FreeBSD、Solaris、PocketPC 等，你所写的 Python 代码无需修改就能在这些平台上正确运行。也就是说，Python 的可移植性是很强的。
