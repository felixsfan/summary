...
在目前所有的操作系统中，linux 中的 epoll、mac 的 kqueue 都属于同步 IO，因为其在第二阶段(数据从内核态到用户态)都会发生拷贝阻塞。而只有 windows 中的 IOCP 才真正属于异步
...
![](C:\Users\felixsfan\Desktop\办公机备份\学习\后台高性能\image\阻塞IO.webp)
...
![](C:\Users\felixsfan\Desktop\办公机备份\学习\后台高性能\image\非阻塞IO.webp)
...
![](C:\Users\felixsfan\Desktop\办公机备份\学习\后台高性能\image\IO多路复用.webp)
...
![](C:\Users\felixsfan\Desktop\办公机备份\学习\后台高性能\image\异步IO.webp)
...
Reactor模式(反应器模式)**事件驱动结构的一种实现**。是一种处理一个或多个客户端并发进行服务请求的。将服务端接收请求与事件处理分离，从而提高系统处理并发的能力
